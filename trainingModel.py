...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            # Getting the data in form of pandas dataframe from the source
            ...
            # check if missing values are present in the dataset or dataframe
            is_null_present,cols_with_missing_values=preprocessor.is_null_present(data)

            # if missing values are there, replace them appropriately and return dataframe
            if is_null_present :
